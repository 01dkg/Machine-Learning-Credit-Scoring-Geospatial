...
library(caret)
mydata <- read.csv("E:/KPMG/Data/Prep/Sample1_3.csv")
fit <- rpart(DefaultedLoans ~ CreditRating+CreditRatingMovement + LoanBalance + PropertyValue+InterestRate + County,method = "class",data=Data, control =  rpart.control(minisplit=15,cp = 0.001))
...
mydata <- read.csv("E:/KPMG/Data/Prep/Sample1_3.csv")
fit <- rpart(DefaultedLoans ~ LoanBalance + PropertyValue+ CreditRating+ AnnualPYMT,method = "class",data=trainData, control =  rpart.control(minisplit=15,cp = 0.001))
