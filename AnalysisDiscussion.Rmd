...
```{r}
#Without Scaling
plot(m1perflr, col='blue', lty=1, main='ROCs: Model Performance Comparision (Modified Data)') # Modified data(without scaling)
...
```{r}
#Final
plot(m3perflr, col='blue', lty=1, main='ROCs: Model Performance Comparision(Original Data') # Modified data(without scaling)
