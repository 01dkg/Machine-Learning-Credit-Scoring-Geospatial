...
=======
lr_KS <- round(max(attr(m1_perf,'y.values')[[1]]-attr(lr_performance,'x.values')[[1]])*100, 2)
lr_AUROC <- round(performance(lr_prediction, measure = "auc")@y.values[[1]]*100, 2)
lr_Gini <- (2*lr_AUROC - 100)
cat("AUROC: ",lr_AUROC,"\tKS: ", m1_KS, "\tGini:", lr_Gini, "\n")
>>>>>>> 6af8e78d55774ecb624a1f9a9b014a3611dadb88
```
