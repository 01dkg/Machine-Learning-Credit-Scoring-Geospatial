...
```{r}
library(readr)
Datav2 <- read_delim("E:/KPMG/KPMG/KPMGv2.csv", 
...
confusionMatrix(testDatav2$prediction,testDatav2$DefaultedLoans)
```
### Accuracy
```{r}
...
```{r}
library(ROCR)
roc_prediction = prediction(testDatav2$prediction, testDatav2$DefaultedLoans)
...
save(lrmodel, file = "trainDatav2.rda")

```

```{r}
load("trainDatav2.rda")
