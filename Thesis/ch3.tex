...
In \citep{can1998gis}, Ayse said that for housing and mortgage spatial data is a critical aspect as housing information remain as is in geographical space. In credit scoring system, one can combine spatial information of a particular location such as employment, property value, property area, average income, etc., with financial data to build a robust predictions model. Ayse, also noted that geospatial data is important for any business and policy, still its usability in mortgage and credit assessment is limited. In recent years, some researchers attempted to incorporate spatial data to estimate house prices\citep{tse2002estimating}, \citet{carling2005asymmetric} combined the geographical information with loan data to examine the credit rationing.\\

Availablity of high end GIS software and enviornment makes it easier to utilise its power to strenth credit scoring model. This not only bank and financial instituions to monitor or predict bad loans based on location, but also enable them to make new business startegies to reach out to unconvered audience or market.
...
>>>>>>> c4f36a331ec612511789f4189e390462ff95d241
